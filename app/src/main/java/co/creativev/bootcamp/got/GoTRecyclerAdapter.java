...
public class GoTRecyclerAdapter extends RecyclerView.Adapter<GoTRecyclerAdapter.GotViewHolder> {
    private final LayoutInflater inflater;
    private final Context context;
    private final DatabaseHelper databaseHelper;
    private Cursor cursor;

    public GoTRecyclerAdapter(Context context, DatabaseHelper databaseHelper) {
    ...
    public void onStart() {
        Log.d(MainActivity.LOG_TAG, "Adapter onStart");
    ...
    public void onStop() {
        Log.d(MainActivity.LOG_TAG, "Adapter onStop");
        closeCursorIfOpen();
    }
